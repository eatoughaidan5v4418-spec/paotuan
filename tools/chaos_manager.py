...
def main():
    ...
    show_p.add_argument("--file", type=Path, default=Path("campaign/chaos_factor.json"))
    sp = adjust_p = sub.add_parser("adjust")
    adjust_p.add_argument("--file", type=Path, default=Path("campaign/chaos_factor.json"))
    sp.add_argument("delta", type=int)
    sp.add_argument("--reason", default="")
    sc_p = sub.add_parser("scene-check")
    sc_p.add_argument("--file", type=Path, default=Path("campaign/chaos_factor.json"))
    sp = roll_p = sub.add_parser("roll")
    roll_p.add_argument("--file", type=Path, default=Path("campaign/chaos_factor.json"))
    ...
    sp = oracle_p = sub.add_parser("oracle")
    oracle_p.add_argument("--file", type=Path, default=Path("campaign/chaos_factor.json"))
