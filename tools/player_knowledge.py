...
def main():
    ...
    list_p.add_argument("--file", type=Path, default=Path("campaign/player_knowledge.json"))
    sub.add_parser("normalize", help="Decode double-escaped text and write the ledger back.")
    sp = add_clue_p = sub.add_parser("add-clue")
    add_clue_p.add_argument("--file", type=Path, default=Path("campaign/player_knowledge.json"))
    ...
    sp = add_npc_p = sub.add_parser("add-npc")
    add_npc_p.add_argument("--file", type=Path, default=Path("campaign/player_knowledge.json"))
    sp.add_argument("npc_id")
    sp.add_argument("known_as")
    sp.add_argument("--role", default="")
    sp.add_argument("--turn", type=int, default=1)
    sp = add_location_p = sub.add_parser("add-location")
    add_location_p.add_argument("--file", type=Path, default=Path("campaign/player_knowledge.json"))
    sp.add_argument("loc_id")
    sp.add_argument("name")
    sp.add_argument("--notes", default="")
    sp = add_fact_p = sub.add_parser("add-fact")
    add_fact_p.add_argument("--file", type=Path, default=Path("campaign/player_knowledge.json"))
